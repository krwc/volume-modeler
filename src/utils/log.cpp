...
static void write_severity_color(ostream &out, Severity severity) {
    switch (severity) {
    case Severity::trace: out << "\033[90m"; break;
    case Severity::debug: out << "\033[37m"; break;
    case Severity::info: out << "\033[92m"; break;
    case Severity::warning: out << "\033[93m"; break;
    case Severity::error: out << "\033[91m"; break;
    default: out << "\033[0m"; break;
    }
}
...
Logger::Logger(Severity severity, const char *filename, int line) : m_stream() {
